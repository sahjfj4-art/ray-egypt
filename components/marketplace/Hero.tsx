         ...
         <div className="flex flex-col md:flex-row items-center justify-between gap-12">
           ...
           <div className="text-center md:text-right max-w-2xl space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start pt-4">
                <button className="px-8 py-4 bg-ray-gold text-ray-black font-bold text-lg rounded-xl shadow-[0_0_20px_rgba(253,184,19,0.3)] hover:shadow-[0_0_30px_rgba(253,184,19,0.5)] hover:-translate-y-1 transition duration-300">
                  ابدأ التسوق الآن
                </button>
                <button className="px-8 py-4 bg-white/10 backdrop-blur-sm border border-white/20 text-white font-bold text-lg rounded-xl hover:bg-white hover:text-ray-blue transition duration-300">
                  اكتشف العروض
                </button>
              </div>
           </div>
